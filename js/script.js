...
function submitForm(inptData, getForm){
    ...
    if(getForm === "syllabus"){
        let {fName, lName, email, city, mobileNo, lookingFor, message} = inptData;
    ...
    if(getForm === "enquiry"){
        let {name, email, mobileNo, lookingFor, message} = inptData;
        $.ajax({
    ...
    if(getForm === "enquire-consulation"){
        let {name, email, mobileNo, lookingFor} = inptData;
        $.ajax({
